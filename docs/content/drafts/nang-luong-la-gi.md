...
Chữ "năng lượng" có mặt trong gần như mọi bài khoa học tự nhiên — từ phản ứng trong lòng [Mặt Trời](/articles/mat-troi) tới lượng calo một người đốt khi [vận động](/articles/van-dong-va-tim-mach). Nhưng bản thân nó là gì?
...
- **electronvolt (eV)** cho thế giới hạt: 1 eV = 1,602176634 × 10⁻¹⁹ J. Đây là con số **chính xác**, không có sai số, vì từ năm 2019 điện tích nguyên tố được định nghĩa cố định (CODATA 2022).
- **kilowatt-giờ (kWh)** trên hoá đơn điện: một kilowatt trong một giờ là 1.000 J/s × 3.600 s = 3,6 triệu J.

## Các dạng năng lượng

Năng lượng được gọi tên theo cách nó đang được giữ hoặc đang di chuyển. Cách nhóm dưới đây là quy ước tiện cho việc giảng giải, không phải bảng phân loại chuẩn của vật lý:
...
## Khối lượng cũng là một dạng năng lượng
