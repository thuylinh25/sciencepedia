...
import { useRadialSprite, type GradientStop } from "@/lib/three/sprites";
import {
  useBulgeGeometry,
  useDiskGeometry,
  useHaloGeometry,
} from "@/components/galaxy/galaxy-geometry";
import {
  DISK_RADIUS,
  GALAXY_FEATURES,
  GALAXY_OBJECTS,
...
const HAZE_SPRITE_SIZE = 256;
const HAZE_STOPS: readonly GradientStop[] = [
  [0, "rgba(255,226,178,0.55)"],
  [0.12, "rgba(255,206,150,0.30)"],
  [0.35, "rgba(176,190,255,0.13)"],
  [0.7, "rgba(120,150,255,0.05)"],
  [1, "rgba(0,0,0,0)"],
];
...
function Galaxy({
  ...
  const haze = useRadialSprite(HAZE_SPRITE_SIZE, HAZE_STOPS);
